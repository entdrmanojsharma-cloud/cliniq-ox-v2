...
3. Under "Connect a repository", find and select your `cliniq-OX` repository.
...
3. Find lines 6 and 11, and replace the old Render URL with the **new Render URL** you copied in Step 2.
   ```toml
   # Example:
   EXPO_PUBLIC_API_URL = "https://your-new-render-url.onrender.com/api/v1"
   ```
